...
doca_error_t create_core_objects(struct app_state *state, char *mmap_name, char *inv_name);

doca_error_t init_core_objects(struct app_state *state, unsigned int max_chunks);

doca_error_t init_core_objects_sender(struct app_state *state, char *mmap_name);
